...
llm = ChatOpenAI(model="gpt-4o", temperature=0, api_key=api_key, http_client=http_client)
...
def ask_bot(message, history):
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            ("system", "Você é um expert em Relações Internacionais. Responda a pergunta do usuário em até 30 palavras"),
            ("human", "{user_input}"),
